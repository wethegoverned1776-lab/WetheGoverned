...
import net.wetheGoverned.data.model.Poll
    ...
    Card(
        ...
        Column(modifier = Modifier.padding(16.dp)) {
            ...
            Row(verticalAlignment = Alignment.CenterVertically) {
                ...
                Text("${poll.upvotes}", style = MaterialTheme.typography.labelLarge)
                Spacer(modifier = Modifier.width(16.dp))
                IconButton(onClick = { onVote(-1) }) {
                    Icon(Icons.Default.ThumbDown, contentDescription = "Downvote")
                }
                Text("${poll.downvotes}", style = MaterialTheme.typography.labelLarge)
            }
        }
    }
}