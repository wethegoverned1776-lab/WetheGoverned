...
android {
    ...
    defaultConfig {
        ...
        buildConfigField("String", "RELAY_URL", "\"wss://relay.wetheGoverned.net\"")
        buildConfigField("String", "CONGRESS_API_KEY", "\"stub\"")
        buildConfigField("String", "OPENSTATES_API_KEY", "\"stub\"")
        buildConfigField("String", "GOOGLE_CIVIC_API_KEY", "\"stub\"")
    }
